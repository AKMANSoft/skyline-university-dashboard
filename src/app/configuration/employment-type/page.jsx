...
import EmploymentType from '@/components/configuration/EmploymentType'
import EditEmpTypeModal from '@/components/configuration/modals/EditEmpTypeModal'
...
const Page = () => {
  ...
  return (
    <main>
      <EditEmpTypeModal modalType="Add" open={openAdd} handleClose={handleCloseAdd} />
      {/* <Sidebar /> */}
