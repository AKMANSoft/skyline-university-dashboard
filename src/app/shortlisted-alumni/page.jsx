...
import ApplicantTable from "@/components/shortlisted-alumni/ApplicantTable";

const values = {
    title: "My Orders",
    links: [{ title: "Shortlisted Alumni’s", path: "shortlisted-alumni" }],
  };

const ShortlistedAlumni = () => {
  return (
    <main>
      <Sidebar />
...
export default ShortlistedAlumni;
