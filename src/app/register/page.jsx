...
import { Box, Card, Typography, Stack, Tabs, Tab, InputLabel, TextField, OutlinedInput, IconButton, InputAdornment, Link, Button } from "@mui/material"
                    ...
                    >
                        ...
                        <Box>
                            ...
                            >
                                ...
                                <Box sx={{width: '100%', maxWidth: '450px', mt: {xs: '22px', sm:'30px'}}}>
                                    <InputLabel 
                                    ...
                                    <TextField 
                                        ...
                                        InputProps={{
                                            sx: {
                                                height: {xs: '38px !important', sm: '42px !important'},
                                            }
                                        }}
                                        sx={{
                                            width: '100%',
                                ...
                                <Box sx={{mt: '18px'}}>
                                    <BlueButton
                                    sx={{
                                        background: 'var(--Gradient, linear-gradient(72deg, #00318B 22.16%, #2C549E 76.47%))',
                                        borderRadius: '6px',
                                        width: '100%',
                                    }}
                                    >
