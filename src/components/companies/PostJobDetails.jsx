...
import { CustomSelect2 } from "../items/select/CustomSelect";
const RichTextEditor = dynamic(() => import("@/components/text-editor"), {
  ssr: false,
});

const appDeadlineOptions = [{label:"Yes", value: "Yes"}, {label:"No", value: "No"}]
const locationOptions = [{label:"Onsite", value: "Onsite"}, {label:"Remote", value: "Remote"}]
const empTypeOptions = [{label:"Full Time", value: "Full Time"}, {label:"Part Time", value: "Part Time"}]
