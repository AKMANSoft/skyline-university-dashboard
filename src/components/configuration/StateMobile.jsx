...
const StateMobile = () => {
  ...
  return (
    <>
    <StateModal open={open} handleClose={handleClose} handleOpenEdit={handleOpenEdit} />
    <EditStateModal modalType="Edit" open={openEdit} handleClose={handleCloseEdit} />
        ...
        <TableRow>
          <TableCell>
            <TableSortLabel
              ...
              direction={sortBy === "stateName" ? sortDirection : "asc"}
              onClick={() => handleSort("stateName")}
              IconComponent={() => (
                <SortIcon active={sortBy === "stateName"} direction={sortDirection} />
              )}
              sx={{
                fontSize: "12px",
                fontWeight: 600,
