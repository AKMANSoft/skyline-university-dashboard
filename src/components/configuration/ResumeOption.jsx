...
import EditResumeOptionModal from "./modals/EditResumeOptionModal";
...
const ResumeOption = () => {
  ...
  return (
    <>
    <EditResumeOptionModal modalType="Edit" open={openEdit} handleClose={handleCloseEdit} />
    <Table sx={{ borderTop: "1px solid #DBDADE" }}>
      <TableHead>
        <TableRow>
          <TableCell>
            <TableSortLabel
              active={sortBy === "resumeOption"}
              direction={sortBy === "resumeOption" ? sortDirection : "asc"}
              onClick={() => handleSort("resumeOption")}
              IconComponent={() => (
                <SortIcon active={sortBy === "resumeOption"} direction={sortDirection} />
              )}
              sx={{
                fontSize: "13px",
                fontWeight: 600,
